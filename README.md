...
- Applicazione Windows `companion/calcioaffari-local-agent` 1.0.4: configurazione completamente grafica, pannello di stato, autoripristino e agente Ollama sulla workstation, senza API IA a consumo.
